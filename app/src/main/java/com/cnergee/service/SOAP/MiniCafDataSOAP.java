...
public class MiniCafDataSOAP 
{
	...
	public MiniCafDataSOAP(String WSDL_TARGET_NAMESPACE, String SOAP_URL, String METHOD_NAME)
	{
	...
	public String FirstInstanceMINICAFData(String CliectAccessId,long CRMUSERID) throws SocketTimeoutException,SecurityException,Exception
	  {
		String result = "OK";
		try
		{
			SoapObject request = new SoapObject(WSDL_TARGET_NAMESPACE,METHOD_NAME);
			 ...
			 pi.setValue(/*MyUtils.CLIENTACCESSID*/CliectAccessId);
			 pi.setType(String.class);
			 request.addProperty(pi);
			 
			 pi = new PropertyInfo();
			 pi.setName("CRMUSERID");
			 pi.setValue(CRMUSERID);
