...
public class ListViewSOAP {
	...
	private String TAG="ListViewSOAP";
	private String jsonResponse="";
	
	public ListViewSOAP(String WSDL_TARGET_NAMESPACE,String SOAP_URL,String METHOD_NAME){
		this.WSDL_TARGET_NAMESPACE=WSDL_TARGET_NAMESPACE;
		this.SOAP_URL=SOAP_URL;
		this.METHOD_NAME=METHOD_NAME;
	}
	
	public String getAllList(String UserId,AuthenticationMobile AuthObj,String ListType) throws SocketException,SocketTimeoutException,Exception{
		String result="OK";
		try{	
	...
	public String getListJsonResponse(){
		return jsonResponse;
	}
