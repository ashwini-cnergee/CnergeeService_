...
public class StatusListSOAP {
	...
	public StatusListSOAP(String WSDL_TARGET_NAMESPACE, String SOAP_URL,
			String METHOD_NAME) {
	...
	public String getStatusList(long userId, String statusType, AuthenticationMobile Authobj)throws SocketException,SocketTimeoutException,Exception{
