...
public class NotificationServiceSOAP {
	...
	private String TAG="NotificationServiceSOAP";
	private String jsonResponse="";
	
	public NotificationServiceSOAP(String WSDL_TARGET_NAMESPACE,String SOAP_URL,String METHOD_NAME){
		this.WSDL_TARGET_NAMESPACE=WSDL_TARGET_NAMESPACE;
		this.SOAP_URL=SOAP_URL;
		this.METHOD_NAME=METHOD_NAME;
	}
	
	public String getAllNotifications(String UserId,AuthenticationMobile AuthObj) throws SocketException,SocketTimeoutException,Exception{
		String result="OK";
		try{
