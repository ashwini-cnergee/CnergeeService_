...
public class AddressDetailsSOAP
{
    ...
    public AddressDetailsSOAP(String WSDL_TARGET_NAMESPACE, String SOAP_URL, String METHOD_NAME)
    {
    ...
    public String GetMiniCAFAddressDetails(String CliectAccessId,String ParamType,String ID) throws SocketTimeoutException,SecurityException,Exception

      {
        ...
        try
        {
            ...
            SoapObject request = new SoapObject(WSDL_TARGET_NAMESPACE,METHOD_NAME);
             ...
             pi = new PropertyInfo();
             pi.setName("ParamType");
             pi.setValue(ParamType);
             pi.setType(String.class);
             request.addProperty(pi);
