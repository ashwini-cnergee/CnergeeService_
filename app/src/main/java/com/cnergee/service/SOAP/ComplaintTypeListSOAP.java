...
public class ComplaintTypeListSOAP {
	...
	public ComplaintTypeListSOAP(String WSDL_TARGET_NAMESPACE, String SOAP_URL,
			String METHOD_NAME) {
	...
	public String getComplaintTypeList(long UserId,AuthenticationMobile Authobj)throws SocketException,SocketTimeoutException,Exception{
		...
		Utils.log("ComplaintTypeListSOAP Soap","request: "+androidHttpTransport.requestDump);
		Utils.log("ComplaintTypeListSOAP Soap","response: "+androidHttpTransport.responseDump);
		ComplaintDetailsActivity.str_response_complaints=androidHttpTransport.responseDump;
