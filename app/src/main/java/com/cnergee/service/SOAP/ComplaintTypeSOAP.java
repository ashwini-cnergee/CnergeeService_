...
public class ComplaintTypeSOAP {
	...
	public ComplaintTypeSOAP(String WSDL_TARGET_NAMESPACE, String SOAP_URL,
			String METHOD_NAME) {
	...
	public String setComplaintTypeList(long userId,int complaintCategoryId,	AuthenticationMobile Authobj)throws SocketException,SocketTimeoutException,Exception{
		SoapObject request = new SoapObject(WSDL_TARGET_NAMESPACE, METHOD_NAME);
		
		/*Log.i(" #	#####################  ", " START ");
		Log.i(TAG+" userId ", ""+userId);
		Log.i(TAG+" ComplaintCategoryId ", ""+complaintCategoryId);
*/		/*Log.i(TAG+" IMEI No ", Authobj.getIMEINo());
		...
		pi.setValue(complaintCategoryId);
